...
cy.wait(3000)            
           ...
           /*  cy.get('[class="css-175oi2r r-12181gd r-1pi2tsx r-13qz1uu r-1ny4l3l"]').click({force:true}).then(() => {
              return someAsyncFunction();
            });
 */

            cy.get('[data-testid="SideNav_AccountSwitcher_Button"]').click({force:true})
...
cy.get('[data-testid="AccountSwitcher_Logout_Button"]').dblclick()
cy.wait(10000)
    
        // cy.get('[data-testid="AccountSwitcher_Logout_Button"]').click({force:true})
        cy.get('[data-testid="confirmationSheetConfirm"]').click({force:true})
         cy.wait(3000)
